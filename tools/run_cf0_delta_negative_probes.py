...
def build_report() -> dict[str, Any]:
    ...
    good_report = ROOT / "generated/cf0-python-cli-calculator/p1.3-maintenance-delta-report.json"
    good_report_data = read_json(good_report)
    ...
    return {
        ...
        "probes": probes,
        "positiveBaseline": {
            "deltaReport": "generated/cf0-python-cli-calculator/p1.3-maintenance-delta-report.json",
            "result": good_report_data.get("result"),
            "sourceTextEqualityRequired": good_report_data.get("sourceTextEqualityRequired"),
            "hiddenGeneratedCodeSnapshotUsed": good_report_data.get("hiddenGeneratedCodeSnapshotUsed"),
            "deltaRecordsVerification": good_report_data.get("deltaRecordsVerification", {}).get("result"),
        },
        "boundaries": {
