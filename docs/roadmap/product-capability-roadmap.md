...
```text
P8.120 captured a valid 1320 x 820 packaged UI screenshot using `PrintWindow` from a sandboxed package copy. Productization is still not claimed; installer, signing, release, product candidate acceptance, and final productization authority remain pending.
```
