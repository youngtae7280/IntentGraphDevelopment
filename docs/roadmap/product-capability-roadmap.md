...
```text
P8.119 recorded exact packaged UI screenshot capture authorization. Next verifier may use `accept-sandboxed-packaged-ui-screenshot-capture`; no screenshot was captured by the authorization record.
```
