...
```text
P8.118 recorded the packaged UI screenshot hold after refreshing the exact request. Required response remains `accept sandboxed packaged UI screenshot capture`; no screenshot was captured.
```
