...
Next safe work must establish logical source identity and profile portability.
...
| H | Productization | Package IntentGraphDevelopment CLI/local app/editor/GitHub/team workflow surfaces. | P9.0 defined `igd-local-review-kit`; P9.1 added a bounded B1 local command/workspace workflow; P9.2 must remove path-bound source identity before broader profile support. |
