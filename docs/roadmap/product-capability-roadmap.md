...
```text
P8.122 requested product candidate acceptance with required response `accept WindowsUtility product candidate`. No candidate was accepted, and no installer, signing, release, or productization claim was performed.
```
